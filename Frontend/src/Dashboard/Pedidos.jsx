          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form className="row g-3">
                ...
                <div className="col-md-6">
                  <label for="inputEmail4" className="form-label border-dark ">Estado de Compra </label>
                ...
                <div className="col-md-6">
                  <label for="inputPassword4" className="form-label border-dark">Fecha de creacion </label>
                ...
                <div className="col-md-6">
                  <label for="formGroupExampleInput2" class="form-label border-dark">cantidad</label>
                  <input type="number" class="form-control" id="formGroupExampleInput2" />
                </div>
                <div className="col-md-6">
                  <label for="formGroupExampleInput2" class="form-label border-dark">precio unitario</label>
                  <input type="text" class="form-control" id="formGroupExampleInput2" />
                </div>

                <div className="col-md-6">
                  <label for="formGroupExampleInput2" class="form-label border-dark">Precio Total</label>
                  <input type="text" class="form-control" id="formGroupExampleInput2" />
                </div>
